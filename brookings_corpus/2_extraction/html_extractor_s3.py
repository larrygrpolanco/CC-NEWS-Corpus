...
try:
    ...
    print("ERROR: The 'warcio' package is not installed. Please run: pip3 install warcio")
    sys.exit(1)
...
def check_aws_credentials():
    ...
    if not credentials or not credentials.access_key:
        print("ERROR: AWS credentials not found. Please run 'aws configure' and ensure you have access to S3.")
        sys.exit(1)
...
def main():
    ...
    print("=====================================")
    print("This script will download and extract HTML files from Common Crawl using your CSV input.")
    ...
    try:
        ...
        print(f"ERROR: Input CSV file '{INPUT_CSV}' not found. Please upload it to the instance.")
        sys.exit(1)
    except Exception as e:
        print(f"ERROR: {e}")
        sys.exit(1)
